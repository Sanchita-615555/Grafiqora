...
export default function ContactSection() {
  return (
    <div className="w-full min-h-screen bg-[#f8f2ec] flex flex-row overflow-hidden">

      {/* Left Side - Text */}
      <div className="flex-1 flex flex-col justify-center p-4 md:p-10 gap-4 z-10 min-w-[40%]">
        <h1 className="text-lg sm:text-xl md:text-4xl lg:text-5xl font-extrabold mb-2 inline-block border-l-4 border-pink-500 pl-3 bg-amber-200">
      ...
      {/* Right Side - Image */}
      <div className="flex-1 min-w-[60%] h-screen">
        <img
