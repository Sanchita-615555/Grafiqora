...
export default function ContactSection() {
  return (
    <div className="w-full min-h-screen bg-[#f8f2ec] flex flex-col md:flex-row">

      {/* Left Side - Text */}
      <div className="flex-1 flex flex-col justify-center p-4 md:p-14 gap-4">
        <h1 className="text-2xl md:text-4xl font-extrabold inline-block border-l-4 border-pink-500 pl-3 bg-amber-200 mb-4">
